  ...
  return (
    <section className="grid grid-cols-1 gap-4 xl:grid-cols-2">
        ...
        <div className="h-72 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={trendData} margin={{ top: 10, right: 16, left: -8, bottom: 0 }}>
              ...
              />
              <Line type="monotone" dataKey="attendance" stroke="#0ea5e9" strokeWidth={3} dot={false} />
            </LineChart>
          </ResponsiveContainer>
        </div>
      </Card>
      ...
      <Card className="rounded-2xl p-5">
        ...
        <div className="h-72 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={classData} margin={{ top: 10, right: 16, left: -8, bottom: 0 }}>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(148,163,184,0.2)" />
              <XAxis dataKey="name" stroke="currentColor" />
              <YAxis domain={[60, 100]} stroke="currentColor" />
              <Tooltip
              ...
              />
              <Bar dataKey="attendance" fill="#22c55e" radius={[10, 10, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </Card>
