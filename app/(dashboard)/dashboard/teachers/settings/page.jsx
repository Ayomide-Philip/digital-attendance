    ...
    <div className="space-y-5">
      ...
      <Card className="rounded-2xl border border-slate-200/70 bg-white/85 p-6 shadow-sm dark:border-slate-800 dark:bg-slate-950/70">
        ...
        <div className="space-y-4">
          ...
          <div className="pt-4">
            <Button className="flex items-center gap-2 rounded-xl bg-emerald-600 px-6 py-2 text-white hover:bg-emerald-700 dark:bg-emerald-700 dark:hover:bg-emerald-600">
